export default function HowDoWeShop() {
  return (
    <>
      <p>
        Go on a Friday Shopping! spree with SHOP. Visit the exhibition happening at Bugis+ Level 1
        (walkway) where the works and exhibits on display will be introduced by Melvin Ho, a
